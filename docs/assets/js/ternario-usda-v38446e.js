...
function bindDomNow(){
 const bind=(sel,fn)=>document.querySelectorAll(sel).forEach(el=>{el.onclick=(ev)=>{ev?.preventDefault?.();ev?.stopPropagation?.();fn(el,ev)}});
 bind('[data-ternario-help]',()=>help());
 bind('[data-ternario-science]',()=>science());
 bind('[data-ternario-open-science]',()=>science());
 bind('[data-ternario-bibliography]',()=>bibliography());
 bind('[data-ternario-return]',()=>returnToDiagram());
 bind('[data-ternario-mode]',el=>setMode(el.dataset.ternarioMode));
